...
@cocotb.test()
async def bare_bones_commentless_test(top):
    """
...
def test_simple() -> None:
    ...
    There are two possible approaches to starting a cocotb test.
    The cocotb.runner is one of them (whereas the other is the Makefile approach).
    """
    runner.run(hdl_toplevel="simple_adder", test_module="tests.test_simple", work=f"test_simple")
